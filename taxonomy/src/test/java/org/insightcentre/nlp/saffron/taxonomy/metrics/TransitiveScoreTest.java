...
public class TransitiveScoreTest {
    ...
    public void testDeltaScore() throws IOException {
        ...
        instance = instance.next("", "a", soln.add("", "a", 0, 0));
        instance = instance.next("ab", "abc", soln.add("ab", "abc", 0, 0));
    ...
    public void testAddMany() throws IOException {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            for (TaxoLink tl : tls) {
                ...
                instance = instance.next(tl.top, tl.bottom, soln.add(tl.top, tl.bottom, 0.0, 0.0));
